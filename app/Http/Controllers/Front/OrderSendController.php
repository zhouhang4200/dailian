...
class OrderSendController extends Controller
{
    ...
    public function complainInfo($tradeNO)
    {
        ...
        return response()->json(view()->make('front.order.complain_info', [
            'order' => $order,
        ])->render());
    }
    ...
    public function complainMessage()
    {
        ...
        try {
            $message = GameLevelingOrderMessage::create([
                ...
                'from_parent_user_id' => $order->take_parent_user_id,
                'from_parent_username' => $order->take_parent_username,
                'to_user_id' => $order->user_id,
                'to_username' => $order->username,
                'to_parent_user_id' => $order->parent_user_id,
                'to_parent_username' =>  $order->parent_username,
