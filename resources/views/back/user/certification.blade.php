                    ...
                    <div class="table-responsive">
                        <div class="layui-tab layui-tab-brief" lay-filter="detail">
                            <ul class="layui-tab-title">
                                <li lay-id="detail"><a href="{{ route('admin.user.show', ['id' => Route::input('id')])  }}">用户资料</a></li>
                                <li class="layui-this" lay-id="authentication"><a href="{{ route('admin.user.certification', ['id' => Route::input('id')])  }}">实名认证</a></li>
                                                ...
                                                <div class="col-xs-12" style="margin-bottom: 20px;">
                                                    <div id="gallery-photos-lightbox">
                                                        <ul class="clearfix gallery-photos">
                                                            ...
                                                            <li class="col-md-4">
                                                                <a href="{{ $realNameCertification->identity_card_hold or '' }}" class="photo-box image-link"
                                                                   style="background-image: url('{{ $realNameCertification->identity_card_hold or '' }}');"></a>
