                    ...
                    <div class="table-responsive">
                        <div class="layui-tab layui-tab-brief" lay-filter="detail">
                            <ul class="layui-tab-title">
                                ...
                                <li lay-id="poundage" class="layui-this"><a href="{{ route('admin.user.poundage') }}?id={{ $user->id }}">手续费设置</a></li>
                                ...
                                @if($userPoundage)
                                    <form class="layui-form" action="" style="width: 500px">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" name="send_poundage" value="{{ $userPoundage->send_poundage +0 }}" lay-verify="" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <label class="layui-form-label">接单手续费比例</label>
                                            <div class="layui-input-block">
                                                <input type="text" name="take_poundage" value="{{ $userPoundage->take_poundage + 0 }}" lay-verify="" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <div class="layui-input-block">
                                ...
                                @else
                                    <form class="layui-form" action="" style="width: 500px">
                                        ...
                                        <div class="layui-form-item">
                                            <label class="layui-form-label">发单手续费比例</label>
                                            <div class="layui-input-block">
                                                <input type="text" name="send_poundage" placeholder="示例：0,0.01,0.05...可为空" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <label class="layui-form-label">接单手续费比例</label>
                                            <div class="layui-input-block">
                                                <input type="text" name="take_poundage" placeholder="示例：0,0.01,0.05...可为空" lay-verify="" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <div class="layui-input-block">
    ...
    <script>
        ...
        layui.use('form', function(){
            ...
            form.on('submit(store)', function (data) {
                $.post("{{ route('admin.user.poundage.store') }}", {
                    id:data.field.id,
                    send_poundage:data.field.send_poundage,
                    take_poundage:data.field.take_poundage
                }, function (result) {
                    if (result.status == 1) {
            ...
            form.on('submit(update)', function (data) {
                $.post("{{ route('admin.user.poundage.update') }}", {
                    id:data.field.id,
                    send_poundage:data.field.send_poundage,
                    take_poundage:data.field.take_poundage
                }, function (result) {
